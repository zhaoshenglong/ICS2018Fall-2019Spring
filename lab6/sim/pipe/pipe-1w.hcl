...
word d_srcA = [
	...
	D_icode in { IPOPQ, IRET, IPOP2 } : RRSP;
...
word d_dstM = [
	D_icode in { IMRMOVQ, IPOPQ, IPOP2 } : D_rA;
	1 : RNONE;  # Don't write any register
];
...
word w_dstE = [
	## writing from valM
	W_icode == IPOP2 : W_dstM;
	W_icode == IPOPQ : W_dstE;
	W_dstM != RNONE : W_dstM;
	1: W_dstE;
];
